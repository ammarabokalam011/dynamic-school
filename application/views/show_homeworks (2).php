...
<section class="trainer_area section_gap_top">
    <div class="container">
        ...
        margin-top:-40px;padding-top:60px;padding-bottom:20px;padding-left:40px;padding-right: 20px;">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 single-trainer" style=" text-align: center ;background:white;margin-right:30px;height: 313px;
             padding-top: 10px;padding-bottom: 30px; ">
                    ...
                    <div class="br"></div>
                   <a href="'.base_url('homework/open_by_id/').$homework->id.'"style="position: absolute;bottom: 0;right: 60px;left: 60px; "
                    class="primary-btn2 mb-3 mb-sm-0" >Try</a>
                    <div class="br"></div>
            </div>';
            }?>
        </div>
