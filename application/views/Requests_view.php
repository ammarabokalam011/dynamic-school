    ...
    <div class="container">
        ...
        <div class="row justify-content-center d-flex align-items-center" >
            <div class="col-lg-4 col-md-6 col-sm-12 single-trainer">
                <div class="justify-content-center d-flex align-items-center" style="margin-top: 40px;margin-bottom: 40px;padding-bottom: 30px;background-color: #f1f9ff;border-radius: 10px" >
